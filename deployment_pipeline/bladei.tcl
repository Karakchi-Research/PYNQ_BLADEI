...
#
# bladei.tcl: Tcl script for re-creating project 'bladei_pynq_z1'
#
# Generated by Vivado on Sat Apr 04 19:52:34 -0400 2026
...
#
# 1. This project restoration tcl script (bladei.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/ip/out_memory/out_memory.xci"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/imports/AES-T100/key_memory.coe"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/imports/AES-T100/state_memory.coe"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/imports/TjFree/table.v"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/imports/TjFree/round.v"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/imports/TjFree/aes_128.v"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/ip/key_memory/key_memory.xci"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/sources_1/ip/state_memory/state_memory.xci"
#    "C:/Users/mcrye/Downloads/PYNQ_BLADEI/deployment_pipeline/bladei_pynq_z1/bladei_pynq_z1.srcs/constrs_1/imports/Constraints/PYNQ-Z1_C.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/trusthub_benchmarks/AES-T100/key_memory.coe"]"\
 "[file normalize "$origin_dir/trusthub_benchmarks/AES-T100/state_memory.coe"]"\
 ...
 "[file normalize "$origin_dir/ip/out_memory/out_memory.xci"]"\
 "[file normalize "$origin_dir/ip/key_memory/key_memory.xci"]"\
 "[file normalize "$origin_dir/ip/state_memory/state_memory.xci"]"\
...
set _xil_proj_name_ "bladei_pynq_z1"
...
import_files -fileset sources_1 [file normalize "${origin_dir}/ip/out_memory/out_memory.xci"]
...
set file "out_memory/out_memory.xci"
...
set file [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/key_memory.coe"]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/state_memory.coe"]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set file [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/src/TjFree/table.v"]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
...
set file [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/src/TjFree/round.v"]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/src/TjFree/aes_128.v"]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
# Set 'sources_1' fileset file properties for local files
set file "key_memory/key_memory.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
# Set 'sources_1' fileset file properties for local files
set file "state_memory/state_memory.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
# Patch .xci coefficient file paths before importing
set key_coe [string map {\\ /} [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/key_memory.coe"]]
set state_coe [string map {\\ /} [file normalize "${origin_dir}/trusthub_benchmarks/AES-T100/state_memory.coe"]]

foreach {xci_file coe_path} [list \
  [file normalize "${origin_dir}/ip/key_memory/key_memory.xci"] $key_coe \
  [file normalize "${origin_dir}/ip/state_memory/state_memory.xci"] $state_coe \
] {
  set f [open $xci_file r]
  set content [read $f]
  close $f
  regsub -all {(\"value\":\s*\")[^\"]*\.coe\"} $content "\\1${coe_path}\"" content
  set f [open $xci_file w]
  puts -nonewline $f $content
  close $f
  puts "INFO: Patched coefficient path in $xci_file to $coe_path"
}
...
set file "Constraints/PYNQ-Z1_C.xdc"
