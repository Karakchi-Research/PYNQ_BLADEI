...
HD_PWD='/share/ryes/Vivado/VivadoProjects/trusthub_pynq_z1/trusthub_pynq_z1.runs/state_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state_memory.tcl
