...
#
# Script generated by Vivado on Thu Dec 18 01:01:13 EST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : key_memory.sh
...
#
# Usage        : key_memory.sh
#                key_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                key_memory.sh [-reset_run]
#                key_memory.sh [-reset_log]
#                key_memory.sh [-help]
#
...
# script info
echo -e "key_memory.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./key_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot key_memory xil_defaultlib.key_memory xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim key_memory -key {Behavioral:sim_1:Functional:key_memory} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb key_memory.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./key_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: key_memory.sh [-help]\n\
Usage: key_memory.sh [-step]\n\
Usage: key_memory.sh [-lib_map_path]\n\
Usage: key_memory.sh [-reset_run]\n\
Usage: key_memory.sh [-reset_log]\n\
Usage: key_memory.sh [-keep_index]\n\
Usage: key_memory.sh [-noclean_files]\n\n\
