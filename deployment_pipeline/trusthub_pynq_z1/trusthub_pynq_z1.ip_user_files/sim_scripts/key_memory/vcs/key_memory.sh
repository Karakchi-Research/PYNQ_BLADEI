...
#                script (type 'key_memory.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.key_memory xil_defaultlib.glbl -o key_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./key_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key key_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc key_memory_simv.daidir vcs_lib c.obj)
