...
#
# Script generated by Vivado on Sat Jul 12 07:52:59 EDT 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : out_memory.sh
...
#
# Usage        : out_memory.sh
#                out_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                out_memory.sh [-reset_run]
#                out_memory.sh [-reset_log]
#                out_memory.sh [-help]
#
...
#                script (type 'out_memory.sh -help' for more information).
#
...
# script info
echo -e "out_memory.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./out_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.out_memory xil_defaultlib.glbl -o out_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./out_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key out_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc out_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./out_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: out_memory.sh [-help]\n\
Usage: out_memory.sh [-step]\n\
Usage: out_memory.sh [-lib_map_path]\n\
Usage: out_memory.sh [-reset_run]\n\
Usage: out_memory.sh [-reset_log]\n\
Usage: out_memory.sh [-keep_index]\n\
Usage: out_memory.sh [-noclean_files]\n\n\
