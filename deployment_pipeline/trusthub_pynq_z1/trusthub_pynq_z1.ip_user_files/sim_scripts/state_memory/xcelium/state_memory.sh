...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.state_memory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.state_memory -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/share/ryes/Vivado/VivadoProjects/trusthub_pynq_z1/trusthub_pynq_z1.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log state_memory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
